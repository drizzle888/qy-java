...
<![endif]-->
	...
	<body>
		<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 统计管理 <span class="c-gray en">&gt;</span> 金币分布统计
		...
		<script type="text/javascript">
			...
			function LoadSerie_Ajax() {
				oChart.showLoading();
				$.ajax({
					url: '${base}/count/getGoldACount.do',
					type: 'POST',
					dataType: 'json',
			...
			function LoadSerie_Ajax1() {
				oChart.showLoading();
				$.ajax({
					url: '${base}/count/getGoldBCount.do',
					type: 'POST',
					dataType: 'json',
					contentType: "application/x-www-form-urlencoded; charset=utf-8",
					success: function(rntData) {
						var oSeries = {
							name: "50-100元的用户数量",
							pointInterval: 24 * 60 * 60 * 1000, //间隔天取一次数据
							pointStart: Date.UTC(2017, 9, 27),
							data: rntData.data
						};
						oChart.addSeries(oSeries);
			...
			function LoadSerie_Ajax2() {
				oChart.showLoading();
				$.ajax({
					url: '${base}/count/getGoldCCount.do',
					type: 'POST',
					dataType: 'json',
					contentType: "application/x-www-form-urlencoded; charset=utf-8",
					success: function(rntData) {
			...
			function LoadSerie_Ajax3() {
				oChart.showLoading();
				$.ajax({
					url: '${base}/count/getGoldDCount.do',
					type: 'POST',
					dataType: 'json',
					contentType: "application/x-www-form-urlencoded; charset=utf-8",
					success: function(rntData) {
