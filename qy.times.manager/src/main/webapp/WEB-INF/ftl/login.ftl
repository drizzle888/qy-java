...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="${base}/user/login.do" method="post">
      <div class="row cl">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
            ...
            使我保持登录状态</label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label style="color:red;font-size:12pt;">${errorInfo}</label>
        </div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
...
<div class="footer">Copyright 武汉游巢网络技术有限公司 by H-ui.admin v3.0</div>
