	...
	<body>
		...
		<article class="page-container">
			<form method="post" class="form form-horizontal" id="form-roundResult-edit" action="${base}/roundResult/edit.do">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${roundResult.roomId}" id="roomId" name="roomId" readonly style="background:#eaeae3;">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">一号玩家输赢金额：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${roundResult.amount0}" id="amount0" name="amount0" readonly style="background:#eaeae3;">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">二号玩家输赢金额：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${roundResult.amount1}" id="amount1" name="amount1" readonly style="background:#eaeae3;">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">三号玩家输赢金额：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${roundResult.amount2}" id="amount2" name="amount2" readonly style="background:#eaeae3;">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">四号玩家输赢金额：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${roundResult.amount3}" id="amount3" name="amount3" readonly style="background:#eaeae3;">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">庄家Id：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${roundResult.masterIdx}" id="masterIdx" name="masterIdx" readonly style="background:#eaeae3;">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">一号玩家的手牌：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${roundResult.beginHands0}" id="beginHands0" name="beginHands0" readonly style="background:#eaeae3;">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">二号玩家的手牌：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${roundResult.beginHands1}" id="beginHands1" name="beginHands1" readonly style="background:#eaeae3;">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">三号玩家的手牌：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${roundResult.beginHands2}" id="beginHands2" name="beginHands2" readonly style="background:#eaeae3;">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">四号玩家的手牌：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${roundResult.beginHands3}" id="beginHands3" name="beginHands3" readonly style="background:#eaeae3;">
					</div>
				</div>
				<!--<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3">胡牌类型：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<span class="select-box" style="width:150px;">
							<select class="select" id="winType" name="winType" disabled style="background:#eaeae3;">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${roundResult.roundCount}" id="roundCount" name="roundCount" readonly style="background:#eaeae3;">
					</div>
				</div>
				<br />
				<div class="line"></div>
		...
		<script>
			...
			$("#form-roundResult-edit").validate({
				...
				messages: {
					roomId: "请输入-房间Id ",
					amount0: "请输入-一号玩家的输赢金额 ",
					amount1: "请输入-二号玩家的输赢金额 ",
					amount2: "请输入-三号玩家的输赢金额 ",
					amount3: "请输入-四号玩家的输赢金额 ",
					masterIdx: "请输入-庄家Id ",
