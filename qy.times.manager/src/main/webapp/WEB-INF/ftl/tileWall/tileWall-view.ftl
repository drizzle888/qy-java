		...
		<article class="page-container">
			<form method="post" class="form form-horizontal" id="form-tileWall-edit" action="${base}/tileWall/edit.do">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${tileWall.tiles}" id="tiles" name="tiles" readonly style="background:#eaeae3;">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">权重值：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${tileWall.weight}" id="weight" name="weight" readonly style="background:#eaeae3;">
					</div>
				</div>
