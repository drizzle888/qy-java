...
<html>
	...
	<body>
		...
		<article class="page-container">
			<form method="post" class="form form-horizontal" id="form-tileWall-add" action="${base}/tileWall/add.do">
				<div class="Huialert Huialert-success"><i class="icon-remove"></i>牌墙详情</div>
				<!--<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">序号：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${tileWall.id}" id="id" name="id" disabled="disabled"></div>
				</div>-->
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">牌墙：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${tileWall.tiles}" id="tiles" name="tiles"></div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">权重值：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${tileWall.weight}" id="weight" name="weight"></div>
				</div>
				<br />
				<div class="line"></div>
				<div class="row cl">
			...
			if (element.attr("name") == "logo") {
				...
				submitHandler: function(form) {
					$.ajax({
						'cache': false,
						'type': "POST",
						'url': '${base}/tileWall/add.do',
						'data': $('#form-tileWall-add').serialize(),
