...
<![endif]-->
		<title>每天在线人数(时间轴折线图)</title>
	</head>

	<body>
		<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 统计管理 <span class="c-gray en">&gt;</span> 每天在线人数(时间轴折线图)
			...
			function LoadSerie_Ajax() {
				...
				$.ajax({
					...
					success: function(rntData) {
						var oSeries = {
							name: "在线用户数量",
							pointInterval: 600 * 1000, //间隔十分钟取一次数据
