...
<![endif]-->
	...
	<body>
		<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 统计管理 <span class="c-gray en">&gt;</span> 新增用户统计
		...
		<script type="text/javascript">
			...
			var oOptions = {
				...
				tooltip: {  //数据提示框
					...
					shared: true,   //两条线的数据提示都显示在一起
					crosshairs: true  //添加一条竖直虚线(引导线)
				},
				plotOptions: {
					area: {
						fillColor: {
			...
			/*function LoadSerie_Ajax1() {
				oChart.showLoading();
				$.ajax({
					url: '${base}/count/getLostCount.do',
					type: 'POST',
					dataType: 'json',
					contentType: "application/x-www-form-urlencoded; charset=utf-8",
					success: function(rntData) {
						var oSeries = {
							name: "流失用户数量(一个星期未登录用户)",
