...
<html>
	...
	<body>
		...
		<article class="page-container">
			<form method="post" class="form form-horizontal" id="form-message-edit" action="${base}/message/edit.do">
				<div class="Huialert Huialert-success"><i class="icon-remove"></i>信息详情</div>
				<div class="row cl">
				...
				<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<textarea name="content" cols="" rows="" class="textarea" >${message.content}</textarea>
						</div>
				</div>
				<div class="row cl">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${message.roomId}" id="roomId" name="roomId">
					</div>
				</div>
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<span class="select-box" style="width:150px;">
							<select class="select" id="playType" name="playType">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${message.lowGold}" id="lowGold" name="lowGold" >
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">圈数：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${message.roundCount}" id="roundCount" name="roundCount" >
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">接收人ID：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${message.toId}" id="toId" name="toId" >
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">房间编号：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${message.roomNumber}" id="roomNumber" name="roomNumber" >
					</div>
				</div>
				<br />
				<div class="line"></div>
			...
			$("#form-message-edit").validate({
				...
				submitHandler: function(form) {
					...
					$.ajax({
						'cache': false,
						'type': "POST",
						'url': '${base}/message/edit.do',
						'data': $('#form-message-edit').serialize(),
